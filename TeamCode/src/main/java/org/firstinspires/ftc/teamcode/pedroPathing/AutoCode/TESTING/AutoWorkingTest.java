package org.firstinspires.ftc.teamcode.pedroPathing.AutoCode.TESTING;
...
public class AutoWorkingTest extends OpMode {
...
//    private ElapsedTime timerRight = new ElapsedTime();
     ...
     */
    private final Pose poseShootPreload = new Pose(32.25, 109.25, Math.toRadians(180)); // increase x lower y to move farther from goal
    private final Pose poseEnd = new Pose(61.75, 79.75, Math.toRadians(180));
    ...
    public void init() {
        ...
        follower.setPose(poseShootPreload);
    ...
    private void buildPaths() {
        pathDriveToEnd = follower.pathBuilder()
                .addPath(new BezierLine(poseShootPreload, poseEnd))
                .setLinearHeadingInterpolation(poseShootPreload.getHeading(), poseEnd.getHeading())
                .build();
    }
