...
public class BLUEFarEndRow2ToRow3 extends OpMode {
    ...
    // --- Tuning Parameters ---
    private double SHOOTING_DURATION_MS = 1500; // Tweak this value to change shooting time
    ...
    private void updateStateMachine() {
        ...
        switch (state) {
            ...
            case statePathShootPreload:
                ...
                if (!pathStarted) {
                    // STEP 1: Spool up flywheels at high power while moving to Goal
