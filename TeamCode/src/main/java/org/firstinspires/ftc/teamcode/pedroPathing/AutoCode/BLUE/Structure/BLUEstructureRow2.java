...
public class BLUEstructureRow2 extends OpMode {
    ...
    private final Pose poseShootRow2 = new Pose(55, 100, Math.toRadians(142)); 
    ...
    private void updateStateMachine() {
        ...
        switch (state) {
            ...
            case statePathThatCollectsRow2:
                ...
                finalIntakeLeft.setPower(F_Intake_Backwards);
                if (!follower.isBusy()) {
                    transition(State.statePathPreparationMovementToMoveToShoot2);
                }
                break;
            ...
            case statePathPreparationMovementToMoveToShoot2:
                if (!pathStarted) {
                    follower.setMaxPower(0.70);
                    follower.followPath(pathPreparationMovementToMoveToShoot2, true);
                    pathStarted = true;
                }
                intake1150.setPower(IntakeInward);
                finalIntakeRight.setPower(F_Intake_Backwards);
