...
//        follower.activateAllPIDFs();
    ...
    public void loop() {
        ...
        telemetryM.addData("Translational_Error", follower.errorCalculator.getTranslationalError());

        // Grabs the rotation offset (heading error) in radians
        telemetryM.addData("Heading_Error", follower.errorCalculator.getHeadingError());
